...
\begin{enumerate}
    ...
    \begin{align*}
        A_1 &= \hash_F\left(\{\rho_\beta\}_{\beta=1}^t\right)F + \hash_H\left(\{\rho_\beta\}_{\beta=1}^t\right)H + \sum_{\beta=1}^t \left( d_{\beta,k}G + \rho_\beta e_{\beta,k}G \right) \\
        A_2 &= \hash_F\left(\{\rho_\beta\}_{\beta=1}^t\right)T_u + \sum_{\beta=1}^t \left( d_{\beta,k}G + \rho_\beta e_{\beta,k}G \right)
    \end{align*}
    ...
    \begin{align*}
        t_1 &= \hash_F\left(\{\rho_\beta\}_{\beta=1}^t\right) + cs_u \\
        t_2 &= \sum_{\beta=1}^t t_{2,\beta} \\
        t_3 &= \hash_H\left(\{\rho_\beta\}_{\beta=1}^t\right) - c\hash_{\text{ser}'}(s_u,D)
    \end{align*}
\end{enumerate}
