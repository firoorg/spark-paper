...
Assume that such a construction is indistinguishable against chosen-plaintext attack (IND-CPA) and indistinguishable against adaptive chosen-ciphertext attack (IND-CCA2) in this context.
...
\begin{itemize}
    ...
    \item Answering $\func{CreateAddress}$ queries: In this case the challenger replaces the public address components $(d,Q_1,Q_2)$ with random strings of the appropriate lengths, producing $\addr_{pk}$ that is returned to $\mathcal{A}$.
